...
public class MyGlimpseProbe_Two extends GlimpseAbstractProbe {
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		MyGlimpseProbe_Two aGenericProbe = new
			...
			DebugMessages.println(MyGlimpseProbe_Two.class.getSimpleName(), "Executing generateAndSendExample_GlimpseBaseEvents_StringPayload method");
			aGenericProbe.generateAndSendExample_GlimpseBaseEvents_StringPayload("Infrastructure Violation");	
	}
}
