...
public class MyGlimpseProbe extends GlimpseAbstractProbe {
	...
	private void generateAndSendExample_GlimpseBaseEvents_StringPayload(String data) {
			...
			message.setData("This is the payload as a String of the message for the event #");
			//	sending
			try {
	...
	private void generateAndSendExample_GlimpseBaseEvents_ExceptionPayload(Exception e) {
		...
		GlimpseBaseEvent<Exception> exceptionEvent = new GlimpseBaseEventImpl<Exception>("eventName",
				"sourceTypeName",
				"sourceInstanceName",
				"messageID",
				000,
	...
	public static void main(String[] args) {
		...
		try {
			...
			aGenericProbe.generateAndSendExample_GlimpseBaseEvents_StringPayload("test");
