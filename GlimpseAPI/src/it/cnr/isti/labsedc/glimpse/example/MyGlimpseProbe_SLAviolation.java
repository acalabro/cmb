...
public class MyGlimpseProbe_SLAviolation extends GlimpseAbstractProbe {
	...
	public static int sendingInterval = 14000;
		...
		try {
			...
			for (int i = 0; i<1;i++) {
				message = new GlimpseBaseEventChoreos<String>(data, 
						...
						"CH1", "TaxiCompanyService",
						InetAddress.getLocalHost().toString()
						);
				
				this.sendEventMessage(message, false);
				DebugMessages.println(
						MyGlimpseProbe_SLAviolation.class.getName(),
						"GlimpseBaseEventChoreos message sent\n"
